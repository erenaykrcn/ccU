...
print("Norm error of the starting point: ", np.linalg.norm(ansatz_sparse(Vlist_start, L, perms, state) - expm_multiply(
...
with h5py.File(f"./triangularTFIM_RQCOPT_SPARSE_{J}{h}{g}_Lx{Lx}Ly{Ly}_t{t}_layers{len(Vlist_start)}_niter5_rS1_2hloc.hdf5", "w") as f:
